        ...
        <section class="p-index__cost" id="cost">
          ...
          <p class="p-index__sub_text">感謝の気持ちを込めてサンキュー価格にしております</p>
           ...
           <div class="twitter">
            ...
            <p><a href="{{ route('user.auth.redirect.provider', 'twitter') }}" class="m-btn" btn-type="twitter"><img src="/images/twi_logo.png" alt="twiter_logo" class="twitter_btn--logo"> Twitterで登録する</a></p>
           </div>
        </section>
