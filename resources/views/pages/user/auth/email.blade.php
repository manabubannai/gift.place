  ...
  <div class="w-4/6 mx-auto">
    ...
    <form action="{{ route('user.auth.store.email') }}" method="POST">
      ...
      <h2 class="text-center mt-16 mb-4">
        ...
        <input id="email" type="email" class="w-full c-input__text mb-4" name="email" value="{{ old('email') ?? old('email') }}" required autocomplete="email" placeholder="メールアドレスを入力してください">
